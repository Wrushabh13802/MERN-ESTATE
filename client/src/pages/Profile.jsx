...
import { updateUserStart ,updateUserSuccess ,updateUserFailure, deleteUserFailure, deleteUserSucces, deleteUserStart, signOutUserStart } from '../redux/user/userSlice';
 ...
 setFileUploadError(true);
  ...
  return (
    ...
    <input onChange={(e) =>setFile(e.target.files[0]) } type="file" ref={fileRef}  hidden accept='image/*'/>
      ...
      {formData.avatar || currentUser.avatar} alt="profile" className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2' />
